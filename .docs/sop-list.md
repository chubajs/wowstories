...
### 2. Шаринг историй
- [x] Создать уникальные URL для каждой истории
- [x] Реализовать страницу для просмотра отдельной истории (app/story/[id]/page.tsx)
- [x] Добавить кнопку "Поделиться" с генерацией ссылки
